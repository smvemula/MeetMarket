...
public class KDCircularProgress: UIView {
    ...
    public func animateToPercentage(percent: Int, completion: ((Bool) -> Void)?) {
        self.animateFromAngle(0, toAngle: (360*percent)/100, duration: 1, completion: completion)
    }
    ...
    public func animateFromAngle(fromAngle: Int, toAngle: Int, duration: NSTimeInterval, relativeDuration: Bool = true, completion: ((Bool) -> Void)?) {
        ...
        if relativeDuration {
           animationDuration = duration
            ...
            let traveledAngle = UtilityFunctions.Mod(toAngle - fromAngle, range: 360, minMax: (-90, 270))
